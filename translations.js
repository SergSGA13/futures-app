...
<div class="content-card"><h3 class="section-title">💰 Расчёт выплат</h3><div class="formula-block"><div class="formula">Сумма расчёта = основная сумма + прибыль</div><div class="formula">Прибыль = сумма × коэффициент выплат</div></div><div class="example-block"><div class="example-title">Пример (выплата 80%, вход 100 USDT):</div><div class="example-row win">✅ Верный прогноз: получаете 180 USDT (+80 USDT)</div><div class="example-row loss">❌ Неверный прогноз: теряете 100 USDT</div><div class="example-row draw">➖ Ничья (цена не изменилась): возврат 100 USDT</div></div></div>`,
...
<div class="content-card"><h3 class="section-title">💰 Розрахунок виплат</h3><div class="formula-block"><div class="formula">сума розрахунку = основна сума + прибуток</div><div class="formula">прибуток = сума × коефіцієнт виплат</div></div><div class="example-block"><div class="example-title">Приклад (виплата 80%, вхід 100 USDT):</div><div class="example-row win">✅ Правильний прогноз: отримуєш 180 USDT (+80 USDT)</div><div class="example-row loss">❌ Неправильний прогноз: втрачаєш 100 USDT</div><div class="example-row draw">➖ Нічия (ціна не змінилась): повернення 100 USDT</div></div></div>`,
